...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1tip8wh");
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "class", "more svelte-1tip8wh");
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(header, "class", "svelte-1tip8wh");
			add_location(header, file$1, 50, 1, 1019);
			add_location(hr, file$1, 58, 1, 1215);
			attr_dev(div, "class", "svelte-1tip8wh");
			add_location(div, file$1, 59, 1, 1221);
			attr_dev(section, "class", "svelte-1tip8wh");
