import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, k as add_location, j as attr_dev, l as insert_dev, m as append_dev, o as set_data_dev, n as noop, p as globals, r as validate_each_argument, u as add_render_callback, w as select_option, x as listen_dev, y as prevent_default, z as destroy_each, A as run_all, B as bubble, C as select_value, D as not_equal, E as create_component, F as claim_component, G as mount_component, H as transition_in, I as transition_out, J as destroy_component, K as binding_callbacks, L as bind, q as query_selector_all, M as add_flush_callback, N as check_outros, O as create_in_transition, P as group_outros } from './client.9a340a47.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option, file$1, 26, 12, 627);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(select, file$1, 24, 4, 526);
			attr_dev(form, "class", "svelte-1851zsd");
			add_location(form, file$1, 23, 0, 490);
		},
		m: function mount(target, anchor) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ adhoc, labels, selected, adhocfiltered });

	$$self.$inject_state = $$props => {
		if ("adhoc" in $$props) $$invalidate(2, adhoc = $$props.adhoc);
		if ("labels" in $$props) $$invalidate(1, labels = $$props.labels);
		if ("selected" in $$props) $$invalidate(0, selected = $$props.selected);
		if ("adhocfiltered" in $$props) $$invalidate(5, adhocfiltered = $$props.adhocfiltered);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*adhoc, selected*/ 5) {
			// // Checkbox Filtering
			// $: subbyhubby = () => {
			...
			// };
			// Filtering
			 $$invalidate(5, adhocfiltered = adhoc.filter(tag => tag.type === selected));
		}

		if ($$self.$$.dirty & /*adhocfiltered*/ 32) {
			 console.log(adhocfiltered);
		}
	};

	return [selected, labels, adhoc, submit_handler, select_change_handler];
}

class Filter extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { adhoc: 2 });
		...
		if (/*adhoc*/ ctx[2] === undefined && !("adhoc" in props)) {
