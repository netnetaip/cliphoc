...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(mark, file, 62, 2, 1280);
			attr_dev(h2, "class", "svelte-1rgvc6f");
			add_location(h2, file, 63, 8, 1334);
			add_location(dt, file, 65, 12, 1382);
			add_location(dd, file, 66, 12, 1418);
			add_location(dl, file, 64, 8, 1365);
			attr_dev(strong, "class", "svelte-1rgvc6f");
			add_location(strong, file, 68, 8, 1462);
			attr_dev(article, "class", "svelte-1rgvc6f");
			add_location(article, file, 56, 4, 1051);
			attr_dev(a, "href", a_href_value = "post/" + /*adhoc*/ ctx[0].id);
			attr_dev(a, "class", "svelte-1rgvc6f");
			add_location(a, file, 55, 0, 1020);
			add_location(hr, file, 71, 0, 1549);
		},
