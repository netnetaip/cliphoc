...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(mark, "class", "svelte-1s9m6gn");
			add_location(mark, file, 72, 2, 1426);
			attr_dev(h2, "class", "svelte-1s9m6gn");
			add_location(h2, file, 73, 8, 1480);
			attr_dev(dt, "class", "svelte-1s9m6gn");
			add_location(dt, file, 75, 12, 1528);
			attr_dev(dd, "class", "svelte-1s9m6gn");
			add_location(dd, file, 76, 12, 1564);
			add_location(dl, file, 74, 8, 1511);
			attr_dev(strong, "class", "svelte-1s9m6gn");
			add_location(strong, file, 78, 8, 1608);
			attr_dev(article, "class", "svelte-1s9m6gn");
			add_location(article, file, 66, 4, 1197);
			attr_dev(a, "href", a_href_value = "post/" + /*adhoc*/ ctx[0].id);
			attr_dev(a, "class", "svelte-1s9m6gn");
			add_location(a, file, 65, 0, 1166);
			add_location(hr, file, 81, 0, 1695);
		},
